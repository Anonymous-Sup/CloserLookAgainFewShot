...
Data["DATA"]["TEST"]["DATASET_ROOTS"] = ['/data/zhengwei/datasets']
Data["DATA"]["TEST"]["DATASET_NAMES"] = ['sketchy']
...
Data["MODEL"]["PRETRAINED"] = '/data/zhengwei/CloserLookAgainFewShot/base_sketchy/vit_CE/main/ckpt_epoch_59.pth'# for example
...
Data["DATA"]["TEST"]["EPISODE_DESCR_CONFIG"]["NUM_TASKS_PER_EPOCH"] = 1000
...
if not os.path.exists('./configs/sketchy/evaluation'):
   os.makedirs('./configs/sketchy/evaluation')

with open('./configs/sketchy/evaluation/finetune_sketchy_vit_CE.yaml', 'w') as f:
